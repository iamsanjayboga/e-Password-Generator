<%@ Page Title="SHA512 Generator - 100% Free Tool" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="sha512-generator.aspx.cs" Inherits="FastPasswordGenerator.sha512_generator" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">

<meta property="og:title" content="SHA512 Generator - 100% Free Tool" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        <div class="row">
            ...
            <div class="col-lg-10">
                <asp:Label ID="sha512generator" runat="server" Text="SHA512 GENERATOR" CssClass="fontsize"></asp:Label>
            </div>
        </div>
        <br />
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-11">
                <asp:Button CssClass="button button5" ClientIDMode="Static" ID="GenerateSHA512" runat="server" Text="Generate SHA-512 Hash" OnClick="GenerateSHA512Hash" />
            </div>
        </div>
        <br />
        <div class="row">
