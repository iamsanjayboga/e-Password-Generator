<%@ Page Title="DES Encryption Online - 100% Free Tool" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="des-encryption-online.aspx.cs" Inherits="FastPasswordGenerator.des_encryption_online" 
    MetaKeywords="des encryption online,s des encryption online,des encryption tool online,online des encryption calculator,triple des encryption online,3 des encryption online" 
    MetaDescription="This free online tool allows you to generate 128 bits MD5 hash of a any string which is useful for encrypting sensitive data like passwords, bank details such as credit card." %>


<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">

<meta property="og:title" content="DES Encryption Online - 100% Free Tool" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        <div class="row">
            ...
            <div class="col-lg-10">
                <asp:Label ID="DESEncryptionOnline" runat="server" Text="DES Encryption Online" CssClass="fontsize"></asp:Label>
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-lg-10">
                <asp:Label ID="DES_Intro" runat="server" Text="This free online SHA-512 (Secure Hash Algorithm 512) generator is a cryptographic hashing tool that helps you to encrypt data like passwords, bank details such as credit cards. You can build SHA-512 hashes of your users' passwords to prevent them from being hacked or stolen, SHA-512 is more secure than SHA-256 and SHA-1."></asp:Label>
            </div>
        </div>
        <br />
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-11">
                <asp:Button CssClass="button button5" ClientIDMode="Static" ID="GenerateDES" runat="server" Text="DES - Encrypt" OnClick="GenerateDESEncrypt" />
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-lg-1">
                <asp:Button CssClass="copybtn" Width="100%" ClientIDMode="Static" ID="decrypt" runat="server" Text="Decrypt" OnClick="DES_Decryption" />
            </div>
        </div>
