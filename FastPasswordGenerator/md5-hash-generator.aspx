<%@ Page Title="MD5 Hash Generator - 100% Free Tool" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="md5-hash-generator.aspx.cs" Inherits="FastPasswordGenerator.md5_hash_generator" 
    MetaKeywords="md5 hash generator,md5 hash generator tool, generate random md5 hash, online generator md5 hash, php md5 hash generator" 
...
<meta property="og:title" content="MD5 Hash Generator - 100% Free Tool" />
<meta property="og:description" content="This free online tool allows you to generate 128 bits MD5 hash of a any string which is useful for encrypting sensitive data like passwords, bank details such as credit card." />
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        <div class="row">
            ...
            <div class="col-lg-10">
                <asp:Label ID="md5hashgenerator" runat="server" Text="MD5 HASH GENERATOR" CssClass="fontsize"></asp:Label>
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-lg-10">
                <asp:Label ID="MD5_Intro" runat="server" Text="This free online tool allows you to generate 128 bits MD5 hash of a any string which is useful for encrypting sensitive data like passwords, bank details such as credit card."></asp:Label>
            </div>
        </div>
        <br />
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-11">
                <asp:Button CssClass="button button5" ClientIDMode="Static" ID="GenerateMD5" runat="server" Text="Generate Hash" OnClick="GenerateMD5Hash" />
            </div>
        </div>
        <br />
        <div class="row">
