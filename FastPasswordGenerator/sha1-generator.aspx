<%@ Page Title="SHA1 Generator" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="sha1-generator.aspx.cs" Inherits="FastPasswordGenerator.sha1_generator" 
    MetaKeywords="sha1 generator,sha1 hash generator,hmac sha1 signature generator,hmac sha1 generator,sha1 key generator,sha1 hash generator online,generate sha1 key android" 
    MetaDescription="This free online SHA-1 (Secure Hash Algorithm 1) generator is a cryptographic hashing tool that helps you to encrypt data like passwords, bank details such as credit cards. You can build SHA1 hashes of your users' passwords to prevent them from being hacked or stolen, SHA-1 is more secure than MD5." %>


<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">

<meta property="og:title" content="SHA1 Generator - 100% Free Tool" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        <div class="row">
            ...
            <div class="col-lg-10">
                <asp:Label ID="sha1generator" runat="server" Text="SHA1 GENERATOR" CssClass="fontsize"></asp:Label>
            </div>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-lg-10">
                <asp:Label ID="SHA1_Intro" runat="server" Text="This free online SHA-1 (Secure Hash Algorithm 1) generator is a cryptographic hashing tool that helps you to encrypt data like passwords, bank details such as credit cards. You can build SHA1 hashes of your users' passwords to prevent them from being hacked or stolen, SHA-1 is more secure than MD5."></asp:Label>
            </div>
        </div>
        <br />
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-11">
                <asp:Button CssClass="button button5" ClientIDMode="Static" ID="GenerateSHA1" runat="server" Text="Generate SHA-1 Hash" OnClick="GenerateSHA1Hash" />
            </div>
        </div>
        <br />
        <div class="row">
